...
<img align="left" width="420" height="315" src="https://github.com/jacobyan0/jacobyan0.github.io/raw/master/images/TRC_RITMO.png" alt="Conceptual illustration of an integrated transit system combining fixed-route transit and ridesourcing services. " style="vertical-align:middle;margin:15px 15px"> In recently years, transit agencies have started to consider integrating ridesourcing services (i.e. on-demand, app-driven ridesharing services) with public transit. In this project, we evaluated traveler preferences for this type of integrated transit system. We find that when used to provide convenient last-mile connections, ridesourcing could provide a significant boost to transit ridership.
