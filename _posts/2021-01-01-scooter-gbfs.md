...
<img align="left" width="435" height="385" src="https://github.com/jacobyan0/jacobyan0.github.io/raw/master/images/ScooterDemand.gif" alt="Animated visualization of shared micromobility demand patterns using GBFS data" style="vertical-align:middle;margin:20px 20px"> In February 2019, I developed a Python program that automatically downloads the General Bikeshare Feed Specification (GBFS) data for multiple U.S. cities. In this study, we developed algorithms to infer micromobility trip origins and destinations based on the GBFS data. 
